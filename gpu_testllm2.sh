...
python fine_tune.py --use-lora --data-csv data/fine_tuning_data/collectivistic_dataset_llm2.jsonl --output-dir output/local_llama3_lora_llm2 --base-model meta-llama/Llama-3.1-8B-Instruct
echo
